...
## 타임라인 (2026 9회 지선)
- **~5/14** : 예비후보자 활동 → preliminary 엔드포인트
- **5/15-16** : 정식 후보자 등록 → 이때 한번 풀스캔
- **5/15 이후** : 정식 후보자 정보 + 정보공개자료 PDF 매일 갱신
- **5/29** (선거 6일 전) : 여론조사 결과 공표 금지 시작
- **6/3** : 선거일
- **6/4 이후** : 당선인 정보 API 활용 (별도 신청 필요)
